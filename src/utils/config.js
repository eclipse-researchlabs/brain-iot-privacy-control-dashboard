...
const BACKEND_PORT = 43080

export const AUTH_ENDPOINT = 'http://'+AUTH_SERVER_IP+":"+AUTH_PORT+"/auth/"
export const BACKEND_ENDPOINT = 'http://'+BACKEND_SERVER_IP+":"+BACKEND_PORT;
